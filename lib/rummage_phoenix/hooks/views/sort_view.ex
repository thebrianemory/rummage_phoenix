        ...
        case current_order do
          "asc" ->
            case asc_sort_icon do
              nil ->
                """
                <a class="text-tca-blue-9 font-semibold uppercase text-sm no-underline" href="#{
                  url
          ...
          _ ->
            """
            <a class="text-tca-blue-9 font-semibold uppercase text-sm no-underline" href="#{url}">#{
              name
            }</a>
            """
        end
